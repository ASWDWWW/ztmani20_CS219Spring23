...
public class LogicExercises {
     ...
     * is between
     * 40 and 60, inclusive. Unless it is the weekend, in which
     * case there is no upper bound on the number of cigars. Return true if
     * the party with the given values is successful, or false
     * otherwise.
     * cigarParty(30, false) = false
     * cigarParty(50, false) = true
     * * cigarParty(70, true) = true
     * caughtSpeeding(65, false) = false
     */
    ...
    /**
     * Return true if d1, d2, d3 are in either ascending or
     * descending order.
    ...
    public static void main(String[] args) {
        ...
        System.out.println(caughtSpeeding(61, false) == 1);
